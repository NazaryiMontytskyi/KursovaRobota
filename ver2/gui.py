...
class ProgrammWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.sound_effect.setSource(QUrl.fromLocalFile("clicked_mouth.wav"))
        ...
        self.choose_method.setGeometry(10, 150, 160, 20)
        ...
        self.iterations_list.label.setFont(QtGui.QFont("Cambria", 11))
    ...
    def show_info(self):
        ...
        msg_info.setText("Даний додаток розв'язує системи "
                         "нелінійних рівнянь різних видів двома ітераційними методами: Якобі та Гауса-Зейделя.\n\n"
                         "Метод Якобі або Метод простої ітерації полягає у обранні початкового вектора та "
                         "підставленні коренів знайдених на попередній ітерації в рівняння на поточній ітерації.\n\n"
                         "Метод Гауса-Зейделя є схожим до попереднього, проте корені знайдені вже на поточній ітерації використовуються "
                         "при обчисленні наступних рівнянь системи.\n\n"
                         "Методи вважаються збіжними, якщо значення визначника матриці Якобі на кожній ітерації менше "
                         "за одиницю(< 1). Матриця Якобі обраховується на кожній ітерації. Важливо враховувати, що "
                         "ітераційні методи не є досконалими і не дають абсолютно точну відповідь.")
    ...
    def write_sol_to_file(self):
        self.sound_effect.play()
        self.solving_equation.write_to_file()
